...
register({ id: 'researcher', name: 'Researcher', description: 'Searches the web, answers questions, summarizes information.', systemPrompt: researcherPrompt, model: 'dynamic', tools: ['search', 'scrape', 'browser', 'memory'], maxTokens: 4096, temperature: 0.7 });
...
register({ id: 'general', name: 'General Assistant', description: 'Casual conversation, help, and general knowledge.', systemPrompt: generalPrompt, model: 'dynamic', tools: ['bash', 'search', 'file', 'cron', 'memory', 'email', 'analytics', 'claude-code'], maxTokens: 4096, temperature: 0.5 });
...
register({ id: 'content-creator', name: 'Content Creator', description: 'Creates AI videos, images, and music, then publishes to social media.', systemPrompt: contentCreatorPrompt, model: 'dynamic', tools: ['kie', 'social', 'bash', 'search', 'file', 'memory', 'workflow'], maxTokens: 4096, temperature: 0.7, maxToolIterations: 12 });
register({ id: 'orchestrator', name: 'Orchestrator', description: 'Manages both ClawdAgent and OpenClaw, delegates tasks to the right system, content pipeline, synergy.', systemPrompt: orchestratorPrompt, model: 'dynamic', tools: ['openclaw', 'kie', 'social', 'bash', 'search', 'db', 'cron', 'memory', 'auto', 'email', 'workflow', 'analytics'], maxTokens: 4096, temperature: 0.4, maxToolIterations: 12 });
